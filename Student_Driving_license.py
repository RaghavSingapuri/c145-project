...
label_name_tag = canvas.create_text(30,100, font=('Times', '12', 'bold') ,text="Name Raghav Singapuri:")
label_dob_tag = canvas.create_text(52,120, font=('Times', '12', 'bold') ,text="Date of birth :1.10/2008")
label_pin_tag = canvas.create_text(32,140, font=('Times', '12', 'bold') ,text="Pin no.395017 :")
label_address_tag = canvas.create_text(36,160, font=('Times', '12', 'bold') ,text="Address xyz:")
label_vehicle_type_tag = canvas.create_text(155,180, font=('Times', '12', 'bold') ,text="Authorisation to drive the following vehicles :two-vehical")
...
# Create a button
Button(
button(width = 20 , activebackground = "#9EC6EE", relief= FLAT)
